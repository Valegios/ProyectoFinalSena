        ...
        <div class="card-body">
            <form action="{{ route('ventas.update', $venta->id) }}" method="POST">
                ...
                <div class="form-control">
                    ...
                    <input type="text" name="fecha" value="{{ $venta->fecha }}" class="input input-bordered" readonly />
                </div>
                <div class="form-control">
                    ...
                    <select name="id_producto" id="id_producto" class="select select-bordered">
                        @foreach($productos as $producto)
                            ...
                            @if($venta->productos->first()->id == $producto->id) selected @endif>  <!-- Asume que cada venta tiene un solo producto -->
                                {{ $producto->nombre }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="form-control">
                    ...
                    <input type="number" id="cantidad" name="cantidad" value="{{ $venta->productos->first()->pivot->cantidad }}" min="1"  class="input input-bordered">
                </div>
