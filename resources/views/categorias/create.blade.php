            ...
            @csrf
                <div class="form-control">
                    <label class="label" for="nombre">
                        ...
                        <input type="text" name="nombre" placeholder="Nombre categoría" maxlength="100" 
                ...
                <div class="form-control">
                    ...
                    <input type="text" name="descripcion" placeholder="Escriba la descripción" maxlength="255" class="input 
                    input-bordered" />
                </div>
